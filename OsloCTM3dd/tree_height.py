...
ax11.plot(np.arange(-90,90.5,0.5), f4(2,0.05), color='brown', linewidth=2.75, label = 'MS')
ax11.plot(np.arange(-90,90.5,0.5), f4(1,0.05), color='orange', linewidth=2.75, label = 'TC')
ax11.plot(np.arange(-90,90.5,0.5), f4(0.3,0.05), color='olive', linewidth=2.75, label = 'GR')
